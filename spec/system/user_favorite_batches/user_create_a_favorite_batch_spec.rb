...
describe 'Usuário tenta criar um lote favorito', selenium: true do
  ...
  it 'e não deve aparecer para outro usuário' do
    video_card_category = ItemCategory.create!(name: 'Placas de Vídeo')
    ...
    expect(page).to have_content('Você ainda não favoritou nenhum lote')
  end
end