...
describe 'Usuário(adm) vê a mudança do botão de mudar o status de resposta na área de dúvidas não respondidas', selenium: true do
  it 'com sucesso' do
    ...
    answer = Answer.create!(user_id: user2.id, doubt_id: doubt.id, content: 'Calma kkkk')
