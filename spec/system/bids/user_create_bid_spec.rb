...
describe 'Usuário tenta dar um lance' do
  it 'e tem sucesso', selenium: true do
  ...
  it 'e falha por tentar dar um lance inferior ao minimo', selenium: true do
    video_card_category = ItemCategory.create!(name: 'Placas de Vídeo')
    ...
    click_on 'Leilões em andamento'
    click_on batch.code
    fill_in 'Valor', with: '28'
    click_on 'Fazer lance!'

    expect(page).to have_content('O valor do lance inicial deve ser igual ou superior o valor do lance mínimo')
  ...
  it 'e falha por tentar dar um lance inferior ao maior lance dado + a minima diferença entre lances', selenium: true do
    video_card_category = ItemCategory.create!(name: 'Placas de Vídeo')
    ...
    expect(page).to have_content('O valor do lance deve ser maior que o valor do ultimo lance + a diferença mínima entre lances')
